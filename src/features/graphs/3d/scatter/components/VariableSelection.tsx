...
export const VariableSelection: FC<VariableSelectionProps> = (props) => {
    ...
    // Wire variable assignment to the store so the modal always has X/Y/Z at Create time
    const { setXVariable, setYVariable, setZVariable } = useScatterPlotStore();
        ...
        <div className={classes.variableContainer}>
            <div className={classes.variableHeader}>
                ...
                <Text size={200} className={classes.variableHeaderSubtitle}>
                    Select variables for your 3D scatter plot. Use the arrows to assign variables to X, Y, and Z axes.
                </Text>
            </div>
