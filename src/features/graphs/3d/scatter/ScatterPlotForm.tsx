...
import { ScatterConfiguration } from './components/ScatterConfiguration';
import { VariableList as VariableListRender } from './ScatterVariableList';
...
/**
 * Main form component for 3D scatter plot configuration
 */
export const ScatterPlotForm: FC<{ projects: string[]; datasets: string[] }> = ({ projects }) => {
    ...
    useEffect(() => {
        ...
        setGraphConfig({
            ...
            // scatterConfig removed as per user request to use defaults/legend
            // scatterConfig: { ... } 
        });
    }, [
        selectedProject,
    ...
    return (
        <div className={classes.root}>
            ...
            {/* Configuration removed as per user request */}
        </div>
    );
};
