import type { Variable } from '../areaPlotSlice';
...
export const getVariablesForSlot = (
    ...
    switch (variableType) {
        ...
        case 'x':
        case 'y':
            // X, Y variables should be numeric
