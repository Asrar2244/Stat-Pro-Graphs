          ...
          <DialogContent style={{ padding: '16px 0' }}>
            ...
            <div style={{
              ...
              <Text size={300} style={{ 
                ...
                💡 <strong>Tip:</strong> Make sure to select the required variables for your chosen line-scatter plot type. 
                Different plot types require different variable combinations (X, Y, Category, Error Bar).
              </Text>
            </div>
          </DialogContent>
        </DialogBody>
