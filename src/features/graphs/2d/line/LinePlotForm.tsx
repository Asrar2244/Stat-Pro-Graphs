...
import { LineHeader } from './components/Header';
...
import { useLinePlotStyles } from './styles-hook/use-line-plot-styles';
import { useLinePlotFormStyles } from './styles-hook';
import { SUB_TYPES } from './constants';
import { useProjectVariables, useVariableManagement, useAvailableFormats } from './hooks';
import { requiresX, requiresY, requiresCategory, canSendToX, canSendToY, canSendToCategory, canSendToErrorBar, isErrorBarSubType, needsErrorBarsConfiguration, isAsymmetricErrorBar } from './utils';
import { FieldValidationIndicator } from './components/ValidationErrors';
import { validateLinePlotRequirements } from './utils/validationUtils';
import { getPlotTypeFlags, isStepPlot, isSplinePlot, isMultiplePlot } from './utils';

/**
 * Main form component for line plot configuration
 */
export const LinePlotForm: FC<{ projects: string[]; datasets: string[] }> = ({ projects }) => {
