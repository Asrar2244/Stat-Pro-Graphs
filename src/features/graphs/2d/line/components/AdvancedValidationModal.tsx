  ...
  const getHelpContent = () => {
    ...
    if (errorFields.includes('xVariables') || errorFields.includes('yVariables')) {
      helpItems.push({
        ...
        content: "Every scatter plot needs at least one X-axis variable and one Y-axis variable. Select variables from your project data to plot on each axis."
      });
    }
    ...
    if (errorFields.includes('categoryVariables')) {
      helpItems.push({
        ...
        content: "Grouped scatter plots require category variables to separate data points into different groups. This creates multiple series in your graph."
      });
    }
