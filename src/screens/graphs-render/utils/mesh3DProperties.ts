...
export const applyMesh3DProperties = (trace: any, properties: Mesh3DProperties): any => {
  console.log('🔍 applyMesh3DProperties called with:', { trace, properties });
  ...
  if (properties.colorScale !== undefined) {
    console.log('🔍 Applying color scale:', properties.colorScale);
    ...
    const colorscaleDefinitions: { [key: string]: any } = {
      ...
      'tab10': [
        ...
        [0.9, 'rgb(23,190,207)'], [1, 'rgb(255,187,120)']
      ],
      'set1': [
        [0, 'rgb(228,26,28)'], [0.125, 'rgb(55,126,184)'], [0.25, 'rgb(77,175,74)'],
        [0.375, 'rgb(152,78,163)'], [0.5, 'rgb(255,127,0)'], [0.625, 'rgb(255,255,51)'],
        [0.75, 'rgb(166,86,40)'], [0.875, 'rgb(247,129,191)'], [1, 'rgb(153,153,153)']
      ],
      'set2': [
        [0, 'rgb(102,194,165)'], [0.125, 'rgb(252,141,98)'], [0.25, 'rgb(141,160,203)'],
        [0.375, 'rgb(231,138,195)'], [0.5, 'rgb(166,216,84)'], [0.625, 'rgb(255,217,47)'],
        [0.75, 'rgb(229,196,148)'], [0.875, 'rgb(179,179,179)'], [1, 'rgb(204,235,197)']
      ],
      'set3': [
        [0, 'rgb(141,211,199)'], [0.1, 'rgb(255,255,179)'], [0.2, 'rgb(190,186,218)'],
        [0.3, 'rgb(251,128,114)'], [0.4, 'rgb(128,177,211)'], [0.5, 'rgb(253,180,98)'],
        [0.6, 'rgb(179,222,105)'], [0.7, 'rgb(252,205,229)'], [0.8, 'rgb(217,217,217)'],
        [0.9, 'rgb(188,128,189)'], [1, 'rgb(204,235,197)']
      ]
    };
      
      const normalizedName = colorScaleName.toLowerCase();
      return colorscaleDefinitions[normalizedName] || colorscaleDefinitions['viridis'];
    };

    updatedTrace.colorscale = getPlotlyColorScale(properties.colorScale);
    console.log('🔍 Applied colorscale:', updatedTrace.colorscale);
  }

  // Apply contours
  if (properties.showContours !== undefined) {
    if (properties.showContours) {
      updatedTrace.contours = {
        x: { show: true, opacity: properties.contourOpacity || 0.5 },
        y: { show: true, opacity: properties.contourOpacity || 0.5 },
        z: { show: true, opacity: properties.contourOpacity || 0.5 }
      };
    } else {
      updatedTrace.contours = undefined;
    }
  }
  ...
  // Apply grid
  if (properties.showGrid !== undefined) {
    if (properties.showGrid) {
      updatedTrace.wireframe = {
        show: true,
        opacity: properties.gridOpacity || 0.6,
        color: 'white'
      };
    } else {
      updatedTrace.wireframe = undefined;
    }
  }
