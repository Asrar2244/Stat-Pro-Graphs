  ...
  return (
    <div className={classes.modelLayout}>
      <div className={classes.modelWrapper}>
        <Fieldset title={t('dependent', { ns: 'regLinearStepwise' })}>
          <DependentListRender />
        </Fieldset>
        <Fieldset title={t('availableVar', { ns: 'regLinearStepwise' })}>
          <AvailableListRender />
        </Fieldset>
        <Fieldset title={t('independent', { ns: 'regLinearStepwise' })}>
      ...
      <Fieldset>
        <div>
          <Checkbox
            name="includeConst"
            label={t('includeConst', { ns: 'regLinearStepwise' })}
...
const IndependentListRender: FC = () => {
  ...
  return (
    <div className="section-available">
      ...
      >
        {t('removeFromIndependent', { ns: 'regLinearStepwise' })}
      </Button>
    </div>
  );
};
  ...
  return (
    <div className="section-available">
      ...
      <Button
        ...
        onClick={onRemoveHandler}
      >
        {t('removeFromDependent', { ns: 'regLinearStepwise' })}
      </Button>
    </div>
  );
};
